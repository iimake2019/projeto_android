...
class FavoritosActivity : AppCompatActivity(), ImageAdapter.OnItemClickListener {
    ...
    private fun inicializaComponentes() {
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Favoritos")
        ...
        q.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                mAdapter = ImageAdapter(this@FavoritosActivity, mUploads)

                mRecyclerView!!.adapter = mAdapter

                mAdapter!!.setOnItemClickListener(this@FavoritosActivity)
            }
    ...
    private fun inicializarFirebase() {
        FirebaseApp.initializeApp(this@FavoritosActivity)
    ...
    override fun onItemClick(position: Int) {
        Toast.makeText(this@FavoritosActivity, "Normal click at position: $position", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onPerfilClick(position: Int) {
        ...
        val intent = Intent(this@FavoritosActivity, PerfilActivity::class.java)
