...
class ArtisticoActivity : AppCompatActivity(), ImageAdapter.OnItemClickListener {
    ...
    private fun inicializaComponentes() {
        ...
        val q = mDatabaseRef!!.orderByChild("categoria").equalTo("Artistico", null)
        q.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                mAdapter = ImageAdapter(this@ArtisticoActivity, mUploads)

                mRecyclerView!!.adapter = mAdapter

                mAdapter!!.setOnItemClickListener(this@ArtisticoActivity)
            }
        ...
        /*mDatabaseRef.orderByKey().equalTo("Artistico").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                    Foto upload = postSnapshot.getValue(Foto.class);
                    mUploads.add(upload);
                }
                mAdapter = new ImageAdapter(ArtisticoActivity.this, mUploads);
    ...
    private fun inicializarFirebase() {
        FirebaseApp.initializeApp(this@ArtisticoActivity)
    ...
    override fun onItemClick(position: Int) {
        Toast.makeText(this@ArtisticoActivity, "Normal click at position: $position", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onPerfilClick(position: Int) {
        ...
        val intent = Intent(this@ArtisticoActivity, PerfilActivity::class.java)
