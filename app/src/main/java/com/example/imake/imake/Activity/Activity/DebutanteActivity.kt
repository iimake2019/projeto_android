...
class DebutanteActivity : AppCompatActivity(), ImageAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_debutante)
    ...
    private fun inicializaComponentes() {
        ...
        val q = mDatabaseRef!!.orderByChild("categoria").equalTo("Debutante", null)
        q.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                mAdapter = ImageAdapter(this@DebutanteActivity, mUploads)

                mRecyclerView!!.adapter = mAdapter

                mAdapter!!.setOnItemClickListener(this@DebutanteActivity)
            }
    ...
    private fun inicializarFirebase() {
        FirebaseApp.initializeApp(this@DebutanteActivity)
    ...
    override fun onItemClick(position: Int) {
        Toast.makeText(this@DebutanteActivity, "Normal click at position: $position", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onPerfilClick(position: Int) {
        ...
        val intent = Intent(this@DebutanteActivity, PerfilActivity::class.java)
