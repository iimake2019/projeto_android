...
class FestaActivity : AppCompatActivity(), ImageAdapter.OnItemClickListener {
    ...
    private fun inicializaComponentes() {
        ...
        val q = mDatabaseRef!!.orderByChild("categoria").equalTo("Festa", null)
        q.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                mAdapter = ImageAdapter(this@FestaActivity, mUploads)

                mRecyclerView!!.adapter = mAdapter

                mAdapter!!.setOnItemClickListener(this@FestaActivity)
            }
    ...
    private fun inicializarFirebase() {
        FirebaseApp.initializeApp(this@FestaActivity)
    ...
    override fun onItemClick(position: Int) {
        Toast.makeText(this@FestaActivity, "Normal click at position: $position", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onPerfilClick(position: Int) {
        ...
        val intent = Intent(this@FestaActivity, PerfilActivity::class.java)
