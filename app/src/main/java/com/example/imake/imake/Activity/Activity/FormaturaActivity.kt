...
class FormaturaActivity : AppCompatActivity(), ImageAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_formatura)
    ...
    private fun inicializaComponentes() {
        ...
        val q = mDatabaseRef!!.orderByChild("categoria").equalTo("Formatura", null)
        q.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                mAdapter = ImageAdapter(this@FormaturaActivity, mUploads)

                mRecyclerView!!.adapter = mAdapter

                mAdapter!!.setOnItemClickListener(this@FormaturaActivity)
            }
    ...
    private fun inicializarFirebase() {
        FirebaseApp.initializeApp(this@FormaturaActivity)
    ...
    override fun onItemClick(position: Int) {
        Toast.makeText(this@FormaturaActivity, "Normal click at position: $position", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onPerfilClick(position: Int) {
        ...
        val intent = Intent(this@FormaturaActivity, PerfilActivity::class.java)
