...
class CasamentoActivity : AppCompatActivity(), ImageAdapter.OnItemClickListener {
    ...
    private fun inicializaComponentes() {
        ...
        val q = mDatabaseRef!!.orderByChild("categoria").equalTo("Casamento", null)
        q.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                mAdapter = ImageAdapter(this@CasamentoActivity, mUploads)

                mRecyclerView!!.adapter = mAdapter

                mAdapter!!.setOnItemClickListener(this@CasamentoActivity)
            }
    ...
    private fun inicializarFirebase() {
        FirebaseApp.initializeApp(this@CasamentoActivity)
    ...
    override fun onItemClick(position: Int) {
        Toast.makeText(this@CasamentoActivity, "Normal click at position: $position", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onPerfilClick(position: Int) {
        ...
        val intent = Intent(this@CasamentoActivity, PerfilActivity::class.java)
